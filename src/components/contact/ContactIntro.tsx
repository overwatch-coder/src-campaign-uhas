...
const ContactIntro = () => {
  return (
    ...
    >
        ...
        We value your feedback, questions, and support. If you have any inquiries or would like to connect with our campaign team, we invite you to get in touch with us. Here is how you can reach us:
        </p>
    </section>
  )
}
