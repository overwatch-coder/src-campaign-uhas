...
const Achievements = () => {
  return (
    ...
    >
        <div className='flex flex-col max-w-3xl mx-auto mb-10 text-center'>
            <h2 className='text-3xl font-semibold text-blue-main font- md:text-4xl'>Achievements</h2>
            <p className='text-black/70 text-sm tracking-wide leading-[1.6]'>Throughout his academic journey, Johnson has actively engaged in various extracurricular activities and demonstrated a strong track record of accomplishments.</p>
        </div>

        <div 
            className='flex flex-col mb-10 md:mt-0 space-y-5 lg:space-y-0 lg:space-x-10 lg:flex-row lg:justify-between'
        >
            <Image 
                src={gallery18}
                alt='Achievement image'
                width={500}
                className=' object-cover w-full md:w-[500px] rounded-xl lg:w-[700px] md:h-[400px] lg:h-[500px]'
            />
