    ...
    >
        ...
        <div className='text-black/70 md:text-center'>
            <p className='leading-[1.7]'>
                John is honored to have received endorsements from respected faculty members, student organizations, and influential individuals. These endorsements highlight the confidence and trust placed in John's leadership abilities and their dedication to the betterment of the student community. 
